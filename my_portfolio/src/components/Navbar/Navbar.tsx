...
import ArrowSvg from './NavSvg/ArrowSvg';

function Navbar()  {
    //navbar hover motion action.
    const [moveArrow, setMoveArrow] = useState(false);
    return (
        <>
            <motion.nav 
                onHoverStart={() => setMoveArrow(true)}
                whileHover={{width: '36vh'}}
                initial={{width:'10vh'}}
                transition={{delay: 0.1}}
                className='navBarComp bg-gradient-to-r from-cyan-500 to-blue-500'
                onHoverEnd={() => setMoveArrow(false)}
            >
                <ArrowSvg moveArrow={moveArrow} />
            </motion.nav> 
            <div>
                            {/* <motion.nav 
            ...
            >
                <ul className="navbar-nav">
                    <li className="logo">
                        <a className="nav-arrow nav-link">
                    ...
                    <li className="nav-item">
                        <a href="#whoim" className="nav-link">
                            <svg
                                aria-hidden="true"
                                focusable="false"
                                data-prefix="fad"
                    ...
                    <li className="nav-item">
                        <a href="#Tendi" className="nav-link">
                            <svg
                                aria-hidden="true"
                                focusable="false"
                                data-prefix="fad"
